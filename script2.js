    ...
    <div class="col-12 col-md-6 col-lg-4 px-1 mb-3">
        <div class="card shadow-sm border overflow-hidden" style="background-color: #fff; border-radius: 12px; border-color: #dee2e6 !important;">
            ...
            <div class="card-body p-0">
                <div id="view-top-value" class="px-2" style="max-height: 295px; overflow-y: auto;">${buildList(topValue, true)}</div>
                <div id="view-top-proj" class="px-2 d-none" style="max-height: 295px; overflow-y: auto;">${buildList(topProj, false)}</div>
            </div>
        </div>
    </div>`;
}
